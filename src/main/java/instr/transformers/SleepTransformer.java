...
public class SleepTransformer extends BodyTransformer {
  ...
  static {
    counterClass    = Scene.v().loadClassAndSupport("instr.util.Sleep");
    increaseCounter = counterClass.getMethod("void sleepIF(java.lang.String)");
